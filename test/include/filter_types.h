...
typedef gammatone::filter::concrete<T,c1,b1>  f11;
typedef gammatone::filter::concrete<T,c2,b1>  f21;
typedef gammatone::filter::concrete<T,c3,b1>  f31;
typedef gammatone::filter::concrete<T,c4,b1>  f41;

typedef gammatone::filter::concrete<T,c1,b2>  f12;
typedef gammatone::filter::concrete<T,c2,b2>  f22;
typedef gammatone::filter::concrete<T,c3,b2>  f32;
typedef gammatone::filter::concrete<T,c4,b2>  f42;

typedef gammatone::filter::concrete<T,c1,b3>  f13;
typedef gammatone::filter::concrete<T,c2,b3>  f23;
