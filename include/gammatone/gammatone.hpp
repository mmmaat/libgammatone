...
/*!
  ...
  gammatone::core contains a concrete implementation of the gammatone
  filter. Moreover, a set of gammatone::policy classes allows the
  static (compile time) customization of the filters.
*/
